...
void use_options_v0(bool flag0, bool flag1, bool flag2, bool flag3, bool flag4, bool flag5, bool flag6, bool flag7)
{
     ...
     cout << "Flag5 is: " << flag5 << ", do something with it." << endl;
     cout << "Flag6 is: " << flag6 << ", do something with it." << endl;
...
void use_options_v1(unsigned char flags)
{
     ...
     cout << "bit0 is " << ((flags & mask_bit_1) >> 1) << ", do something with it!" << endl;
     cout << "bit0 is " << ((flags & mask_bit_2) >> 2) << ", do something with it!" << endl;
     cout << "bit0 is " << ((flags & mask_bit_3) >> 3) << ", do something with it!" << endl;
     cout << "bit0 is " << ((flags & mask_bit_4) >> 4) << ", do something with it!" << endl;
     cout << "bit0 is " << ((flags & mask_bit_5) >> 5) << ", do something with it!" << endl;
     cout << "bit0 is " << ((flags & mask_bit_6) >> 6) << ", do something with it!" << endl;
     cout << "bit0 is " << ((flags & mask_bit_7) >> 7) << ", do something with it!" << endl;
}
...
int main()
{
     ...
     cout << "---------------------------------" << endl;
     use_options_v1(mask_bit_2 | mask_bit_4 | mask_bit_6);
     return 0;
}
